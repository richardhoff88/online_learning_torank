...
def sequential_injection_attack(n_arms, target_arm, rho, T, means, std_devs, R, n_tilde, delta0=0.05):
    ...
    for t in range(1, T + 1):
        ...
        if arm != target_arm and arm_pulls[arm] >= threshold:
            ...
            rf = np.clip(rf, 0.0, 1.0)  # Bound the fake reward
...
def experiment_sequential_injection(T=100000, n_arms=10, rho=1.0, sigma=1.0, delta0=0.05):
...
if __name__ == "__main__":
    experiment_sequential_injection()
